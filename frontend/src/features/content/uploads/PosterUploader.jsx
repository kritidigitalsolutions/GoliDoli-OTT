...
import { Upload, Image as ImageIcon, Trash2, CheckCircle2, Link2 } from "lucide-react";
  ...
  return (
    <div className="form-row media-uploader-box">
      ...
      {inputMode === "file" ? (
        ...
        >
          {file ? (
            <div className="upload-preview-container poster-aspect">
              <img src={previewSrc} alt="Poster Preview" className="upload-img-preview" />
            ...
            <div className="upload-empty-state">
              ...
              <p className="upload-primary-text">Drag & drop poster image or <span>browse</span></p>
              <p className="upload-sub-text">PNG, JPG, WEBP (Recommended: 600x900px)</p>
            </div>
          )}
        ...
        <div className="url-input-block">
          <input
            ...
            name="poster"
            placeholder="Paste direct poster image URL (https://...)"
            onChange={onUrlChange}
            value={value}
          />
          {value && (
            <div className="upload-preview-container poster-aspect" style={{ marginTop: 10 }}>
              <img src={value} alt="Poster URL Preview" className="upload-img-preview" onError={(e) => e.currentTarget.style.display = 'none'} />
              <div className="upload-preview-overlay">
                <span className="file-info-badge">
